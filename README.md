...
[![GoDoc](https://godoc.org/github.com/Bot-Hive-Trading/go-binance?status.svg)](https://godoc.org/github.com/Bot-Hive-Trading/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/Bot-Hive-Trading/go-binance)](https://goreportcard.com/report/github.com/Bot-Hive-Trading/go-binance)
...
```shell
go get github.com/Bot-Hive-Trading/go-binance/v2
```

For v1 API, it has been moved to `v1` branch, please use:

```shell
go get github.com/Bot-Hive-Trading/go-binance/v1
```
...
```golang
import (
    "github.com/Bot-Hive-Trading/go-binance/v2"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/Bot-Hive-Trading/go-binance) for full references.
